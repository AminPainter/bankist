...
const scrollTillElement = document.getElementById('section--1');

btnScroll.addEventListener('click', () => scrollTillElement.scrollIntoView({ behavior: 'smooth' }));
...
tabBtnsContainer.addEventListener('click', e => {
    ...
    tabs[clickedBtn.dataset.tab - 1].classList.add('operations__content--active');
});
